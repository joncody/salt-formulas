...
[custom.sudoers](https://github.com/joncody/salt-formulas/blob/master/bashrc/files/custom.sudoers) is a one liner appended to `/etc/sudoers` enabling all users of group `sudo` to execute the `find` command without having to type in a password.
